    ...
    return (
        <div className="ds-section-spacing animate-in fade-in duration-700">
            ...
            <PageHeader
                ...
                badge={<div className="h-2 w-2 rounded-full bg-orange-500 animate-pulse" />}
                actions={
                    <button
                        onClick={() => fetchWashers(1)}
                        className="p-3 bg-white ring-1 ring-slate-200 rounded-2xl text-slate-400 hover:text-orange-500 transition-all shadow-sm"
                    >
                    ...
                    {!isLoading && filteredWashers.length === 0 ?
                        ...
                        filteredWashers.map((washer) => (
                            <motion.div
                                ...
                                key={washer.id}
                            >
                                <Card className="group border-none shadow-xl ring-1 ring-slate-100 hover:ring-orange-500/20 transition-all overflow-hidden bg-white rounded-3xl">
                                    <div className="p-6 space-y-5">
                                        {/* Top Header */}
                                        <div className="flex justify-between items-start">
                                            <div className="flex gap-4">
                                                <div className="relative">
                                                    <div className="h-14 w-14 rounded-xl bg-orange-50 text-orange-600 flex items-center justify-center font-black text-base ring-2 ring-white shadow-sm">
                                                    ...
                                                    <div className={cn(
                                                        ...
                                                        washer.status === 'available' ? 'bg-orange-500' : 'bg-slate-300'
                                                    )} />
                                                </div>
                                                <div>
                                                    <h4 className="text-sm font-black text-slate-900 group-hover:text-orange-600 transition-colors">{washer.name}</h4>
                                        ...
                                        <div className="pt-2 flex items-center gap-2">
                                            ...
                                            <button
                                                ...
                                                className="p-2.5 bg-slate-100 text-slate-600 rounded-xl hover:bg-orange-50 hover:text-orange-600 transition-all"
                                            >
                    ...
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                        ...
                        >
                            <div className="flex justify-between items-start mb-6">
                                <div className="flex gap-4">
                                    <div className="h-16 w-16 bg-orange-50 text-orange-600 rounded-xl flex items-center justify-center font-black text-lg">
                            ...
                            <form onSubmit={handleEditSubmit} className="space-y-4">
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 border-none rounded-xl text-xs font-bold outline-none focus:ring-2 focus:ring-orange-500/10 transition-all"
                                    />
                                </div>
                                <div className="space-y-1">
                                ...
                                <button type="submit" className="w-full py-3.5 bg-[color:var(--primary)] text-white rounded-xl text-xs font-black uppercase tracking-widest shadow-lg hover:opacity-90 transition-all mt-4">
                                    SAVE CHANGES
                                </button>
                            </form>
                        </motion.div>
