        ...
        {isLoading && (
          <div className="absolute inset-0 bg-white/60 dark:bg-slate-900/60 backdrop-blur-[1px] z-10 flex items-center justify-center">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="ds-caption text-gray-500 font-medium">Loading Categories...</p>
            </div>
          </div>
        )}
          ...
          <table className="ds-table">
            <thead className="ds-table-header">
              <tr>
                ...
                <th className="ds-table-header-cell">Parent Header</th>
              ...
              {!isLoading && filteredCategories.length === 0 ? (
                <tr>
                  <td colSpan="7" className="px-6 py-20 text-center">
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <p className="ds-h4 text-gray-400">No categories found</p>
                    </div>
                  </td>
                </tr>
              ) : (
                paginatedCategories.map((cat) => (
                  <tr key={cat._id || cat.id} className="ds-table-row">
                    ...
                    <td className="ds-table-cell text-slate-500">
                      <Badge
                        variant="gray"
                      >
