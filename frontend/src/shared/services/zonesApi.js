 ...
 * the admin courier company form (which zones a courier company covers),
 * and the customer outstation pickup picker (which zone a pickup point
 * resolves to). One fetch, cached
